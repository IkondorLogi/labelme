...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def _update_shape_color(self, shape):
        ...
        fillShapeR, fillShapeG, fillShapeB = self._get_rgb_by_label(shape.label)
        shape.line_color = QtGui.QColor(r, g, b)
        shape.vertex_fill_color = QtGui.QColor(fillShapeR, fillShapeG, fillShapeB)
        shape.hvertex_fill_color = QtGui.QColor(255, 255, 255)
        shape.fill_color = QtGui.QColor(fillShapeR, fillShapeG, fillShapeB, 128)
